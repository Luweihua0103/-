<template>
  <div class="m-life">
    <el-row>
      <ul class="nav">
        <li>
          <router-link to="/s" class="takeout">美团外卖</router-link>
        </li>
        <li>
          <router-link to="/s" class>猫眼电影</router-link>
        </li>
        <li>
          <router-link to="/s" class>美团酒店</router-link>
        </li>
        <li>
          <router-link to="/s" class="apartment">民宿/公寓</router-link>
        </li>
        <li>
          <router-link to="/s" class="business">商家入驻</router-link>
        </li>
        <li>
          <router-link to="/s" class>美团公益</router-link>
        </li>
      </ul>
    </el-row>
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-login">
          ...
          <p class="m-life-login-mame">Hi！{{$store.state.userName ? $store.state.userName : '你好'}}</p>
